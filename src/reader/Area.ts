...
export type Room = Partial<MapData.Room> & {
    render: paper.Path
    exitsRenders: (paper.Path | paper.Group)[]
}
...
export default class Area {
    ...
    constructor(areaId: string, areaName: string, rooms: Room[], labels: Label[], zIndex: number, levels: Set<number>) {
        this.areaId = areaId;
    ...
    limit(id: number, padding: number) {
